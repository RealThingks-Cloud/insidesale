  ...
  const configs: Record<string, ColumnConfig> = {
    contacts_module: {
      allowedColumns: [
        ...
        'phone_no', 'mobile_no', 'linkedin', 'website', 'contact_source',
        'industry', 'country', 'region', 'tags', 'description', 'segment',
        'last_contacted_at', 'contact_owner', 'created_by', 'modified_by',
    ...
    leads: {
      allowedColumns: [
        ...
        'phone_no', 'mobile_no', 'linkedin', 'website', 'contact_source',
        'lead_status', 'industry', 'country', 'region', 'no_of_employees',
        'annual_revenue', 'description', 'contact_owner', 'created_by', 
